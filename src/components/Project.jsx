...
const projectData = [
  ...
  },
  {
    ...
    description: "Built a responsive platform with user/admin roles, JWT auth, REST APIs, Cloudinary, and an admin dashboard.",
    image: "/photo2.jpg",
    sourceCode: "https://github.com/royujjwal-99",
    demo: "https://frontend-wine-seven-27.vercel.app/",
  },
  {
    id: 3,
    title: "React-country ",
    description: "A React-based web app that displays a list of countries along with interesting facts about each one. Features an interactive UI for exploring country names, basic details, and unique facts, making it both informative and engaging.",
    image: "/web.jpg",
    sourceCode: "https://github.com/royujjwal-99/React-country",
    demo: "https://react-country-six.vercel.app/",
  },
  {
    id: 4,
    title: "react-food-delivery-app",
    description: "A modern and responsive food delivery web application built with React, Bootstrap, and React Router. The app provides a seamless experience for users to explore the restaurant’s menu, search for dishes, and place orders.",
    image: "/photo.jpg",
    sourceCode: "https://github.com/royujjwal-99/react-food-delivery-app",
    demo: "https://react-food-delivery-app-y7gh.vercel.app/",
  },
];
